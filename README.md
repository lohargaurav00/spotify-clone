...
This is a Full Stack Spotify Clone with Next.js 13.4 App Router: React, Tailwind, Supabase, PostgreSQL, Stripe
...
```shell
git clone https://github.com/lohargaurav00/spotify-clone.git
```
...
Running commands with npm `npm run or yarn [command]`
